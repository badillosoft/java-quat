...
public class EmpleadoDTO {
	...
	String adoGenero;
	@NonNull
	Timestamp adoFechaNacimiento;
	@NonNull
	String adoCorreo;
	@NonNull
	Timestamp adoFechaIngreso;
	...
	public Timestamp getAdoFechaNacimiento() {
	...
	public Timestamp getAdoFechaIngreso() {
	...
	public void setAdoFechaNacimiento(Timestamp adoFechaNacimiento) {
	...
	public void setAdoFechaIngreso(Timestamp adoFechaIngreso) {
